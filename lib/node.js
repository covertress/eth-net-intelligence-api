...
var WS_SECRET = process.env.WS_SECRET || "a38e1e50b1b82fa";
...
function Node ()
{
	this.info = {
		...
		contact: (process.env.CONTACT_DETAILS || "covertress@gmail.com"),
		coinbase: null,
		node: null,
		net: null,
		protocol: null,
		api: null,
		port: (process.env.LISTENING_PORT || 17171),
		os: os.platform(),
		os_v: os.release(),
...
Node.prototype.startWeb3Connection = function()
{
	...
	web3 = new Web3();
	web3.setProvider(new web3.providers.HttpProvider('http://' + (process.env.RPC_HOST || 'localhost') + ':' + (process.env.RPC_PORT || '8888')));
